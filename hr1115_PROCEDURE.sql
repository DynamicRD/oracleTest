...
CREATE OR REPLACE PROCEDURE PROCEDURE_INOUTMODE(
    VSALARY IN OUT VARCHAR2)
IS
BEGIN
    --VSALARY := TO_CHAR(VSALARY ,'$999999999');
    VSALARY := '$' ||SUBSRT(VSALARY, -9,3)||','||SUBSTR(VSALARY,-6,3)||','||SUBSTR(VSALARY,-3,3);
END;
/
